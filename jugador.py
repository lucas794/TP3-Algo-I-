...
class Jugador(object):
    ...
    def asignar_carta(self, carta):
        ...
        de cartas."""
        self.lista_cartas.asignar_carta(carta)
    ...
    def alguna_carta(self, jugada):
        ...
        cartas_a_mostrar = list( set(self.lista_cartas.obtener_mano()) & set(jugada) )
    ...
    def sugerir(self, tablero, otros_jugadores):
        ...
        self.pedidos.mostrar_mano(self.lista_cartas.obtener_mano())
        ...
        #Si llego aqui significa que el loop salio sin pausarse
